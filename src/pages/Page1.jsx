...
export const Page1 = () => {
  ...
  //const { arr, word, completeTodo, onChangeAdd, onClickAdd, onClickDelete, onClickComplete, onClickBack } = useTodoData();
  ...
  //useEffect(() => {
    ...
    //onClickComplete();
    //onClickBack();
  //},[onChangeAdd, onClickAdd, onClickDelete, onClickComplete, onClickComplete, onClickBack])
  ...
  <div className="container-style">
    ...
    <div>
      <div>        
        <h2>今からやるで！</h2>        
        <form>
          <input type="text" onChange={onChangeAdd} value= {word} placeholder="何やるか決めた？"/>        
